...
from analysis_qutip import num_sites, psi0, psi0_label, st_L, st_R
...
TARGET_NU = 10   # ⟵ ajuste ici
TARGET_NT = 10   # ⟵ ajuste ici
USE_PARALLEL        = True
...
sigma_x = 15e-9
x = build_adaptive_x_grid(dot_x, sigma_x, well_width_nm, barrier_widths_nm, safety_pts=16, span_sigma=5)
Ny = 40
